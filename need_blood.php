...
<body>
  ...
  <style>
    body {
        background-image: url('images/becomeadoner.jpg');
  ...
  <div class="row">
      <div class="col-lg-6">
          <h1 class="mt-4 mb-3"><strong>Need Blood</strong></h1>
...
<div class="col-lg-4 mb-4">
<div class="font-italic"><strong>Reason, why do you need blood?</strong><span style="color:red">*</span></div>
...
<div class="col-lg-4 col-sm-6 portfolio-item">
  <div class="card" style="width:300px;">
    <img class="card-img-top" src="images/donner.jpeg" alt="Card image " style="width:100%; height:300px;">
    <div class="card-body">
