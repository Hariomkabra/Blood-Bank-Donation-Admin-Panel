  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images\home.jpg" alt="image\home1" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="images\home2.jpg" alt="image\home2" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;" >Welcome to BloodBank & Donoation Bank</h1>
<br>
        <div class="row">
          ...
          <?php
           ...
           ?>
            ...
            <div class="card" style="width:300px">
                <img class="card-img-top" src="images\donner11.jpg" alt="Card image" style="width:100%;height:300px">
                <div class="card-body">
